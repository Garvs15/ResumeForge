    ...
    return (
        <section className="py-24 md:py-32 px-4 sm:px-6 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-5xl mx-auto">
                {/* Deocrative elements specific to the heading */}
                ...
                {/* Leading badges - multi-color approach insperied by Hero.tsx */}
                <motion.div
            ...
            >
                <h3 className="text-xl text-muted-foreground mb-8">Trusted by Students & Professional Developers</h3>
            ...
            >
                <div className="max-w-3xl mx-auto px-6 py-12 rounded-2xl bg-gradient-to-br from-white/50 to-white/30 backdrop-blur-lg border border-white/40 shadow-xl">
                    ...
                    <p className="text-lg text-muted-foreground mb-8">
                        Join 50,000+ professionals who are getting more interviews with ResumeForge
                    </p>
