...
import { ArrowRight, Clock, Crown, Sparkles } from "lucide-react";
...
export function ApiKeyAlert({ variant = 'upgrade' }: { variant?: ApiKeyAlertVariant }) {
    // Use Synchronized hook for instant updates when API Keys Changed
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs text-gray-500">
                                    {variant === 'trial' ? 'Join  1,800+ users building with ResumeForge' : 'Join 1,800+ users building with ResumeForge'}
                                </p>
                            </div>
                            ...
                            <div className="mt-3 pt-3 border-t border-gray-200/60">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4 text-xs text-gray-500">
                                        ...
                                        <a href="https://platform.openai.com/docs/quickstart/create-and-export-an-api-key"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="inline-flex items-center gap-1 hover:text-purple-600 transition-colors">
