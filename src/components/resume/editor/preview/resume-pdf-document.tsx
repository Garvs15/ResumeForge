...
import { Text, View, Link, StyleSheet, Document as PDFDocument, Page as PDFPage, Image } from "@react-pdf/renderer";
...
// Create a cache outside of components to persist b/w renders
...
function useTextProcessor() {
    const processText = useCallback((text: string, ignoreMarkdown = false) => {
        ...
        // if ignoring markdown, extract content b/w asterisks or return plain text
        if (ignoreMarkdown) {
