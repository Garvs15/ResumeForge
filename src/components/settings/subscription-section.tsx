...
import { ArrowRight, Check, Clock, Crown, Shield, Sparkles, Star, TrendingUp, Users, Zap } from "lucide-react";
    ...
    return (
        <div className="space-y-8">
                    ...
                    <>
                        <div className="flex items-center justify-center mb-2">
                            <Badge variant="outline" className="text-blue-700 border-blue-300 bg-blue-50">
                                {trialDaysRemaining > 0 ? `${trialDaysRemaining} days left in the trial` : 'Trial ends today'}
                            </Badge>
                        </div>
                        <h2 className="text-2xl font-bold text-gray-900">
            ...
            <div className="flex items-center justify-center text-sm text-gray-600">
                ...
                <span>Trusted by 12,000+ professional!</span>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                    <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm relative overflow-hidden">
                        ...
                        {/* CTA Button */}
                        <Button onClick={handlePortalSession}
                            disabled={isLoading}
                            className={cn(
                                "w-full py-3 font-semibold rounded-lg transition-all duration-300",
                                hasProAccess ? "bg-gray-100 text-gray-700 hover:bg-gray-200"
