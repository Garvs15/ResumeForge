...
function SocialAuth() {
    ...
    return (
        <div className="space-y-3 mt-4">
            ...
            <Button
                variant="outline"
                className="w-full h-10 bg-white border-slate-200 hover:bg-slate-50 hover:border-slate-300
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogTrigger asChild>
                {children || (
                    <Button
                        size="lg"
                        className={`${gradientClasses.base} ${gradientClasses.hover} text-white font-semibold text-lg
                        py-6 px-10 ${gradientClasses.animation} group shadow-xl shadow-violet-500/30 hover:shadow-violet-500/40
                        ring-2 ring-white/20 hover:ring-white/30 scale-105 hover:scale-110 transition-all duration-300
            ...
            >
                <AuthProvider>
                    ...
                    <div className="px-6 pt-6">
                        ...
                        >
                            <TabsList className="
                            w-full h-10 bg-violet-50/30 border border-violet-100/50 p-1 flex gap-0.5 rounded-lg
                            ">
