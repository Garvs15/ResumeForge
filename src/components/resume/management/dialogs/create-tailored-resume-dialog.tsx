...
import { ApiKey, Profile, ResumeSummary } from "@/lib/types";
import { useState } from "react";
import { CreationStep, LoadingOverlay } from "../loading-overlay";
...
import { Brain, Copy, Loader2, Plus, Sparkles } from "lucide-react";
import { CreateBaseResumeDialog } from "./create-base-resume-dialog";
import { Button } from "@/components/ui/button";
import { cn } from "@/lib/utils";
import { BaseResumeSelector } from "../base-reume-selector";
...
export function CreateTailoredResumeDialog({ children, baseResumes, profile }: CreateTailoredResumeDialogProps) {
    ...
    function buildErrorDescription(summary: string, error: unknown) {
        ...
        return `${summary}${detailsText}. Contact the developer at hi@garvs0041 for help.`;
    }
        ...
        try {
            ...
            if (importOption === 'import-profile') {
                ...
                if (jobDescription.trim()) {
                    ...
                    const LOCAL_STORAGE_KEY = 'resumeforge-api-keys';
    ...
    return (
        <>
          ...
          `}</style>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1">
                                ...
                                <DialogDescription className="text-sm text-gray-600">
                                    {dialogStep === 1 ? "Choose a base resume to start with"
                                        : "Configure the Job Deatils and tailoring method"
                                    }
                                </DialogDescription>
                            </div>
                            {/* Step Indicator */}
                    ...
                    {/* Content */}
                    <div className="px-2 py-2 min-h-[400px] relative">
                        ...
                        {dialogStep === 2 && (
                            <div className="space-y-6">
                                ...
                                <div className="bg-gradient-to-r from-purple-50 to-pink-50 border-purple-200 rounded-lg p-3">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex items-start gap-2">
                                            ...
                                            <div className="space-y-1">
                                                ...
                                                <ul className="text-xs text-blue-600 space-y-0.5">
                                                    ...
                                                    <li className="flex items-center gap-2">
                                                        <div className="w-1 h-1 rounded-full bg-blue-400"></div>
                                                        Optimises your experience descriptions
                                                    </li>
                                                    <li className="flex items-center gap-2">
                                                        <div className="w-1 h-1 rounded-full bg-blue-400"></div>
