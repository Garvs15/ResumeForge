            ...
            >
                {plans.map((plan) => (
                    ...
                    >
                        ...
                        <AuthDialog>
                            <button
                                className={`block w-full py-3 rounded-lg font-medium text-center transition-all duration-300 hover:-translate-y-1 mb-8
                            ${plan.ctaSecondary ? "bg-white border border-indigo-200 hover:bg-indigo-50"
