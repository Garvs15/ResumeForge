            ...
            {education.map((edu, index) => (
                <Card key={index} className={cn(
                    ...
                    <CardContent className="p-3 sm:p-4 space-y-3 sm:space-y-4">
                        <div className="space-y-2 sm:space-y-3">
                            {/* School Name and delete btn row */}
                            ...
                            <div className="relative group">
                                <Input
                                    ...
                                    placeholder="e.g., &apos;2022 - Present&apos"
                                />
                                <div className="absolute -top-2 left-2 px-1 bg-white/80 text-[7px] sm:text-[9px] font-medium text-indigo-700">
                                    DATE
                                </div>
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Tiptap
                                    ...
                                    onChange={(newContent) => updateEducation(index, 'achievements', newContent.split('\n').filter(Boolean))}
                                    editorProps={{
                                        attributes: {
                                            placeholder: "• Second Prize in Major Project Exhibition 2025"
                                        }
                                    }}
                                    className={cn(
