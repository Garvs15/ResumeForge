import { DocumentSettings, Education, Project, Skill, WorkExperience } from "@/lib/types";
import dynamic from "next/dynamic";
import type { ComponentType } from "react";
import { LoadingFallback } from "./shared/LaodingFallback";
...
export const WorkExperienceForm = dynamic(() => import('./forms/work-experience-form').then(mod => ({ default: mod.WorkExperienceForm })) as Promise<ComponentType<WorkExperienceFormProps>>,
    {
...
export const SkillsForm = dynamic(
    () => import('./forms/skills-form').then(mod => ({ default: mod.SkillsForm })) as Promise<ComponentType<SkillFormProps>>,
    {
        loading: () => <LoadingFallback lines={1} />,
        ssr: false,
    }
