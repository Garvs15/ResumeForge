import { ResumeSortControls, SortDirection, SortOption } from "@/components/resume/management/resume-sort-controls";
...
export default async function ResumesPage({
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-rose-50/50 via-sky-50/50 to-purple-50/50">
