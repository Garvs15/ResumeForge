...
import { SavedStyleDialog } from "./saved-styles-dialog";
...
export function DocumentSettingsForm({ documentSettings, onChange }: DocumentSettingsFormProps) {
    ...
    // Initialize the document_settings if it doesnt exists
    if (!documentSettings) {
            ...
            <div className="space-y-2">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center">
                        ...
                        />
                        <span className="text-xs text-muted-foreground mt-1">pt</span>
                    </div>
                </div>
                <Slider
                    ...
                    <div className="grid grid-cols-2 gap-4 pt-2">
                        ...
                        >
                            ...
                            <div className="relative h-full w-full flex flex-col items-center">
                                ...
                                <div className="flex-1 w-full p-1 flex flex-col justify-start space-y-2">
                ...
                <CardContent className="space-y-8">
                    <div className="space-y-6">
                        ...
                        <div className="space-y-2 bg-slate-50/50 rounded-lg border border-slate-200/50">
                            <div className="flex items-center justify-between space-x-2">
                                ...
                                <Switch checked={documentSettings?.show_ubc_footer ?? false}
                            ...
                            {/* Footer with control - Only shown when footer is enabled */}
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        />
                                        <span className="text-sm text-muted-foreground/60 ml-1">pt</span>
                                    </div>
                                </div>
                                <Slider
                                    value={[documentSettings?.document_font_size ?? 10]}
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="h-[1px] flex-1 mb-4 bg-gradient-to-r from-teal-200/20 via-cyan-200/20 to-transparent" />
                        </div>
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            <Label className="text-base font-semibold bg-gradient-to-r from-teal-600 to-cyan-600 bg-clip-text text-transparen">Skills</Label>
                            <div className="h-[1px] flex-1 mx-4 bg-gradient-to-r from-teal-200/20 via-cyan-200/20 to-transparent" />
                        </div>
