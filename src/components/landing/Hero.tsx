            ...
            <div className="w-full lg:w-1/2 space-y-8">
                ...
                <div className="flex justify-start">
                    <a
                        ...
                        className="flex items-center border border-red-400 rounded-xl px-4 py-2 text-red-500 hover:bg-red-50 transition">
                        {/* Badge Logo Circle */}
                        <div className="flex items-center justify-center w-8 h-8 rounded-full bg-red-500 text-white font-bold mr-3">
                            RF
                        </div>
                        {/* Badge Text */}
                        <div className="flex flex-col leading-tight">
                            <span className="text-xs font-semibold">RESUME FORGE</span>
                            <span className="text-sm font-bold">Shaping careers with precision-crafted, job-ready resumes.</span>
                        </div>
                        {/* Upvote section */}
                        <div className="flex items-center ml-3">
                            <ArrowUp className="h-4 w-4 text-red-500" />
                            <span className="ml-1 text-sm font-semibold text-red-500">15</span>
                        </div>
                    </a>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-8">
                    <AuthDialog>
                        <button className="px-6 py-3 rounded-lg bg-indigo-600 text-white font-medium transition-all duration-300 hover:-translate-y-1 flex items-center justify-center"
                ...
                {/* Features badges with simplified styling */}
                <div className="flex flex-wrap gap-3 mt-6">
                    ...
                    <span className="px-3 py-1 rounded-full bg-emerald-50 text-sm border border-emerald-200 text-emerald-700">100%</span>
