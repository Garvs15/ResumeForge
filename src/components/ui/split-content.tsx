...
export function SplitContent({
    ...
    return (
        <div className={cn(
            ...
            "before:absolute before:inset-0 before:bg-gradient-to-b before:from-violet-50/80 before:via-blue-50/80 before:to-indigo-50/80 before:opacity-75",
            ...
            <div className="relative w-full px-4 sm:px-6 lg:px-8">
                <div className={cn(
                    ...
                    {/* Image Section - Enahnced for screenshots */}
                    <div className={cn(
                        ...
                        <div className="relative h-full w-full overflow-hidden rounded-2xl shadow-2xl">
                            ...
                            <div className="relative h-full w-full p-2">
                                ...
                                {/* Subtle Shine effect */}
                                <div className="absolute inset-0 bg-gradient-to-tr from-white/0 to-white/0 opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-xl" />
                            </div>
                        </div>
                    </div>

                    {/* Content Section - Enhanced Typography with Layout */}
                    {!imageOverflowRight && (
                        <div className={cn(
                            "relative flex flex-col gap-8 lg:col-span-2",
