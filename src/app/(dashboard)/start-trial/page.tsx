            ...
            <main className="relative z-10 container mx-auto px-4 py-12 max-w-5xl">
                ...
                >
                    ...
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        Try ResumeForge Pro free for 7 days. Cancel anytime before your trial ends and you won&apos;t be charged.
                    </p>
                </motion.div>
                ...
                <div className="grid lg:grid-cols-2 gap-8 items-start">
                    ...
                    <motion.div
                        ...
                        <div className="grid sm:grid-cols-2 gap-3">
                            ...
                            <div className="bg-white/60 backdrop-blur-sm rounded-xl border border-purple-100/50 p-4">
                                <div className="flex items-start gap-3">
                                    <div className="w-9 h-9 bg-indigo-100 rounded flex items-center justify-center flex-shrink-0">
                    ...
                    >
                        <div className="bg-white rounded-2xl border border-purple-200 p-8 shadow-xl relative overflow-hidden">
                            ...
                            <div className="text-center mb-6">
                                ...
                                <h3 className="text-2xl font-bold text-gray-900 mb-2">ResumeForge Pro</h3>
                            ...
                            <div className="space-y-4 mb-6">
                                ...
                                <div className="flex items-start gap-3 p-3 bg-purple-50 rounded-lg border border-purple-100">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-purple-600">No Charge if you cancel before trials</p>
                                    </div>
                                </div>
                            </div>
