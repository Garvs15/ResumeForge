            ...
            <div className="fex-1 space-y-8">
                ...
                <Card id="api-keys" className="border-white/40 shadow-xl shadow-black/5 bg-white/80 backdrop-blur-xl">
                    <CardHeader>
                        ...
                        <CardDescription className="">Manage your API keys for different AI Provider</CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                <Card id="ai-prompts" className="border-white/40 shadow-xl shadow-black/5 bg-white/80 backdrop-blur-xl">
                    <CardHeader>
                        ...
                        <CardDescription>Customize AI Prompts </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <AIPromptsForm />
                    </CardContent>
