...
import { ApiKey, Education, Profile, Project, WorkExperience } from "@/lib/types";
...
import { AlertTriangle, Briefcase, FolderGit2, GraduationCap, Linkedin, Loader2, Save, Trash2, Upload, User, Wrench } from "lucide-react";
import {
    Dialog,
    DialogContent,
    DialogDescription,
...
export function ProfileEditForm({ profile: initialProfile }: ProfileEditFormProps) {
    ...
    const handleResumeUpload = async (content: string) => {
        try {
            ...
            if (result) {
                // Clean and transform the data to match our databse schema
    ...
    return (
        <div className="relative mx-auto">
            ...
            {/* Main Content container with persistent styling */}
            <div className="relative px-6 md:px-8 lg:px-10 pb-10">
                                        ...
                                        >
                                            ...
                                            <div className="relative flex items-center gap-4">
                                                ...
                                                <div className="text-left">
                                                    ...
                                                    <div className="text-sm text-violet-600/70">Import from the existing resume</div>
                                                </div>
                                            </div>
                                        </Button>
                                    </DialogTrigger>
                ...
                {/* Enhances Tabs with smooth transitions and connected design */}
                <div className="relative">
                    <div className="relative">
