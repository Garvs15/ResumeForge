...
import { DocumentSettings, Job, Profile, Resume } from "@/lib/types";
...
export function EditorPanel({
    ...
    return (
        <div className="flex flex-col sm:mr-4 relative h-full max-h-full">
            ...
            <div className={cn(
                "flex w-full bottom-0 rounded-lg border",
                resume.is_base_resume
                    ? "bg-purple-50/50 border-purple-200/40"
                    : "bg-pink-50/50 border-pink-300/50 shadow-sm shadow-pink-200/20"
            )}>
                <Chatbot
                    resume={resume}
                    onResumeChange={onResumeChange}
