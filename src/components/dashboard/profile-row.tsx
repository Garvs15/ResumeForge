                ...
                <div className="px-4 sm:px-6 py-3">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6 max-w-7xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-4 flex-1 min-w-0">
                            ...
                            {/* Stats Row - hidden on mobile, visible on sm nd up */}
                        ...
                        <Link href="/profile" className="shrink-0">
                            <Button variant="outline" size="sm" className="w-full sm:w-auto bg-gradient-to-r from-teal-50 border-teal-200 hover:border-teal-300 text-teal-700
                        hover:bg-gradient-to-r hover:from-teal-100 hover:to-cyan-100 transition-all duration-500 hover:-translate-y-0.5 hover:shadow-md shadow-sm
                        ">
