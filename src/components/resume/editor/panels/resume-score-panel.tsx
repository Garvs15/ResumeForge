...
import { Resume, Job as JobType, ApiKey } from "@/lib/types";
import { cn } from "@/lib/utils";
import { generateResumeScore } from "@/utils/actions/resumes/actions";
import { Award, RefreshCw, Target, TrendingUp } from "lucide-react";
...
const LOCAL_STORAGE_KEY = 'resumeforge-resume-scores';
const MAX_SCORES = 10;
...
function getStoredScores(resumeId: string): ResumeScoreMetrics | null {
    try {
        ...
        console.error('Error reading the stored scores:', error);
        return null;
    }
}
...
function updateStoredScores(resumeId: string, score: ResumeScoreMetrics) {
    try {
        ...
        // Maintain only MAX_SCORE entries
...
export default function ResumeScorePanel({ resume, job }: ResumeScorePanelProps) {
    ...
    // When have score data, show the full analysis
    return (
        <div className="space-y-4">
            ...
            {/* Job Specific Improvement for Tailored Resumes */}
